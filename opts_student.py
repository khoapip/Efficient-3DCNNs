...
def parse_opts_student():
    ...
    parser.add_argument('--n_classes', default=600, type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51)')
    ...
    parser.add_argument('--lr_steps', default=[5, 10], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
    ...
    parser.add_argument('--n_epochs', default=25, type=int, help='Number of total epochs to run')
    ...
    parser.add_argument('--pretrain_path', default='pretrained_models/kinetics_mobilenetv2_1.0x_RGB_16_best.pth', type=str, help='Pretrained model (.pth)')
